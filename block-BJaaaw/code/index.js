...
let numA = prompt("provide first number");
let numB = prompt("provide second number");
...
*/
let houseName = prompt("provide house name!");
if (houseName === "stark") {
...
let month = prompt("provide the month number here");
switch (month)
		{
			case "1": alert("31"); break;
			case "2": alert("28"); break;
			case "3": alert("31"); break;
			case "4": alert("30"); break;
			case "5": alert("31"); break;
			case "6": alert("30"); break;
			case "7": alert("31"); break;
			case "8": alert("31"); break;
			case "9": alert("30"); break;
			case "10": alert("31"); break;
...
*/
let salary = prompt("provide the salary");

switch(true){
  case salary <= 20000:
    let tax = (salary * 10) / 100;
    alert(`In-hand salary is ${salary - tax}`);
    break; 
    case salary <= 40000:
...
switch(true) {
  case marks > 100 : alert(`Marks can't be greater than 100`); break;
...
switch(true) {
  ...
  case weather === "freezing" : alert(`Get your sweater on`); break;
